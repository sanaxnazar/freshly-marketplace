...
## Demo 🚀 
 ...
 https://freshly-marketplace.onrender.com/
...
- Real-time rendering of grocery items (Fruits, Vegetables, Dairy) sourced from MongoDB Atlas.
- A custom-designed UI focused on an organic, "fresh" aesthetic.
- Fully optimized for both desktop and mobile browsing.
- Quickly find specific fresh picks across categories.
